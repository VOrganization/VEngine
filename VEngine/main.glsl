...
vec3 CalcPointLight(_lightPoint light, vec3 normal, vec3 viewDir, vec3 FragPos, vec3 ambient, vec3 diffuse, vec3 specular, float shininess);
layout(std430, binding = 3) buffer LightP{
	uint lightPointSize;
